...
import com.dinesh.firstspringbootapp.service.DepartmentService;
...
public class DepartmentController 
{
	...
	@GetMapping("/departments/dcode/{dcode}")
	public List<Department> fetchDepartmentByCode(@PathVariable("dcode") String departmentCode)
	{
